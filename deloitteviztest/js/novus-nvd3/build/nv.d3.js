            ...
            switch (axis.orient()) {
                ...
                case 'left':
                    ...
                    axisLabel
                        ...
                        .attr('transform', rotateYLabel ? 'rotate(-90)' : '')
                        .attr('y', rotateYLabel ? (-Math.max(margin.left, width) + 25 - (axisLabelDistance || 0) - 40) : -10)
                        .attr('x', rotateYLabel ? (-d3.max(scale.range()) / 2) : -axis.tickPadding());
                    if (showMaxMin) {
                        axisMaxMin = wrap.selectAll('g.nv-axisMaxMin')
                            .data(scale.domain());
    ...
    function chart(selection) {
        ...
        selection.each(function(data) {
            ...
            if (showXAxis) {
                ...
                if(rotateLabels)
                    var rotateDegrees = rotateLabels
                    xTicks
                        .selectAll('text')
                        .attr('transform', function(d,i,j) { return 'translate (-10, 10) rotate(' + rotateDegrees + ' 0,0)' })
                        .style('text-anchor', rotateDegrees > 0 ? 'start' : 'end');
